...
def install_kivy_mocks():
    ...
    _MockCanvas = type("_MockCanvas", (), {
        "__enter__": lambda self: self,
        "__exit__": lambda self, *a: None,
        "clear": lambda self: None,
        "before": MagicMock(),
    })
    _make_mock_module("kivy.uix.widget", {"Widget": type("Widget", (), {
    ...
    _make_mock_module("kivy.properties", {
    ...
    # Kivy graphics
    _make_mock_module("kivy.graphics", {
        "Color": MagicMock(),
        "Rectangle": MagicMock(),
        "Line": MagicMock(),
        "Ellipse": MagicMock(),
    ...
    _make_mock_module("kivymd.app", {"MDApp": type("MDApp", (), {
        "__init__": lambda self, **kw: None,
        "theme_cls": MagicMock(),
    })})
    _make_mock_module("kivymd.uix", {})
    _make_mock_module("kivymd.uix.screen", {"MDScreen": type("MDScreen", (), {
        "__init__": lambda self, **kw: None,
    })})
    _make_mock_module("kivymd.uix.screenmanager", {"MDScreenManager": MagicMock})
    _make_mock_module("kivymd.uix.boxlayout", {"MDBoxLayout": type("MDBoxLayout", (), {
        "__init__": lambda self, **kw: None,
    ...
    _make_mock_module("kivymd.uix.label", {"MDLabel": type("MDLabel", (), {
        "__init__": lambda self, **kw: None,
        "bind": lambda self, **kw: None,
    })})
    _make_mock_module("kivymd.uix.button", {
    ...
    _make_mock_module("kivymd.uix.navigationrail", {
        "MDNavigationRail": MagicMock,
        "MDNavigationRailItem": MagicMock,
    })
    _make_mock_module("kivymd.uix.bottomnavigation", {
